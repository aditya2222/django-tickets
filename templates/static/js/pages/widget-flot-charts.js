...
var newCust = [[0, 2], [1, 3], [2,6], [3, 5], [4, 7], [5, 8], [6, 10]];
  ...
  var plot = $.plot($('#flotLine1'),[
   ...
   update_plot5();
	...
	/**************** PIE CHART *******************/
   var piedata = [
      { label: "Series 1", data: [[1,10]], color: '#04a9f5'},
      { label: "Series 2", data: [[1,30]], color: '#465161'},
      { label: "Series 3", data: [[1,90]], color: '#14cc9e'},
      { label: "Series 4", data: [[1,70]], color: '#f4c22b'},
      { label: "Series 5", data: [[1,80]], color: '#f44236'}
	 ];
