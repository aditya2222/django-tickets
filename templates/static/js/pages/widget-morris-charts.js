...
$(function(){
  ...
  new Morris.Bar({
    ...
    barColors: ['#04a9f5', '#14cc9e','#01CB99'],
    gridTextSize: 11,
    hideHover: 'auto',
    resize: true
  });
  ...
  new Morris.Line({
    ...
    ykeys: ['a', 'b', 'c'],
    labels: ['Series A', 'Series B', 'Series C'],
    lineColors: ['#14cc9e', '#04a9f5', '#f4c22b'],
    lineWidth: 1,
    ymax: 'auto 100',
    gridTextSize: 11,
    hideHover: 'auto',
  ...
  new Morris.Donut({
    ...
    colors: ['#14cc9e','#04a9f5','#f4c22b','#f44236'],
    resize: true
  });
