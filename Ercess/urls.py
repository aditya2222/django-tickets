...
#    url(r'^live/reset_password/$', views.resetPassword,name='reset-password'),
    ...
    url(r'^live/sell_event_stalls/$',views.sellstallspaces, name='sell-event-stalls'),
    url(r'^live/paid_advertisement/$', views.advertisement,name='advertisement'),
    url(r'^live/how_it_works/$',views.howitworks, name='how-it-works'),
    ...
    url(r'^live/privacy_policy/$', views.privacypolicy , name='privacy-policy'),
